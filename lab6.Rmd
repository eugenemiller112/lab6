...
## Eugene Miller
Correlating late aircraft delay and departure delay
...
ggplot(DENflights) +
  ...
  labs(x = "Late Aircraft Delay (min)", y = "Departure Delay (min)")
```

If the aircraft was delayed by at least 5 minutes, what's the probability of a departure delay?
```{r}
lateAircraft <- DENflights %>%
  filter(LATE_AIRCRAFT_DELAY > 5)
...
If a plane arrives late then it's departure was more than likely delayed.
